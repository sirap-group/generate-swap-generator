...
**Showing support for generate-swap-project**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for generate-swap-project:

- star the [project](https://github.com/rbecheras/generate-swap-project)
- tweet your support for generate-swap-project
...
- **version**: please note the version of generate-swap-project are you using
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using
- **error messages**: please paste any error messages into the issue, or a [gist](https://gist.github.com/)

### Closing issues

The original poster or the maintainer's of generate-swap-project may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/generate-swap-project
